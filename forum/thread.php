      ...
      // ok
        ...
        if($page == 1) {
          ...
          if($creatorRow->{'power'} > '4'){
            echo '<br><span style="color: #0000BF;"><i class="fa fa-gavel" aria-hidden="true"></i>TDBDNH Administration</span><br>';}
        ...
        <div style="margin-top:20px;float:left;">
          ...
          if($loggedIn) {
            if($power >= 5) {
              echo '<span><a class="label" href="scrub?id='.$threadID.'">Scrubb</a></span>
