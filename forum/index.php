...
<html>
	<head>
		<title>Forum - Data Hill</title>
	</head>
	<body>
		<div id="body">
			<table width="100%" cellspacing="1" cellpadding="4" style="border:0px;" style="background-color:#000;">
				<tbody>
					<tr>
						<th width="50%" style="border-radius:12px 0px 0px 0px;">
						...
						<th width="26%" style="border-radius:0px 12px 0px 0px;">
					...
					while($forumRow=$boardResult->fetch_assoc()) {
						...
						$table .= '<tr class="forumColumn" style="border:0px;">
						<td>
							<a class="title" href="board?id=' . $forumID .'">' . $forumRow['name'] . '</a>
							<p class="description">' . $forumRow['description'] . '</p>
						</td>
						<td style="text-align:center;">
							<p class="description" style="font-size:26px;">' . $topicsResult->num_rows . '</p>
						</td>
						<td style="text-align:center;">
							<p class="description" style="font-size:26px;">' . ($count+$topicsResult->num_rows) . '</p>
						</td>
						<td>
