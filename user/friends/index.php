...
<html>
	...
	<head>
		<title>Friends - Data Hill</title>
	</head>
	
	<body>
		<div id="body">
			<div id="column" style="float:left; width:435px;">
			<div id="box">
				...
				<?php 
					...
					echo '</div></div></div></div><div id="column" style="float:right; width:435px;"><div id="box"><div id="friends">
